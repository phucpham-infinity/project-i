...
class Workspaces {
    ...
    readProjectsConfig(opts) {
        ...
        this.cachedProjectsConfig = this.mergeTargetDefaultsIntoProjectDescriptions(workspace, nxJson);
        return this.cachedProjectsConfig;
    }
    /**
    ...
    readWorkspaceConfiguration(opts) {
        const nxJson = this.readNxJson();
        return Object.assign(Object.assign({}, this.readProjectsConfig(opts)), nxJson);
    }
...
function assertValidNxJson(nxJson) {
